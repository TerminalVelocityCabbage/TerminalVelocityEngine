...
public class TexturedCuboid {

	public static MeshPart createTexturedCuboid(ModelVertex frontTL, ModelVertex frontBL, ModelVertex frontBR, ModelVertex frontTR,
